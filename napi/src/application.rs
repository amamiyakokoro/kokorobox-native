...
pub fn get_native_capabilities() -> JsNativeCapabilities {
    ...
    JsNativeCapabilities {
        ...
        service_lifecycle: capabilities.service_lifecycle,
        managed_file_permissions: capabilities.managed_file_permissions,
        ...
        windows_privilege_relaunch: capabilities.windows_privilege_relaunch,
        windows_uwp_loopback: capabilities.windows_uwp_loopback,
        windows_service_status: capabilities.windows_service_status,
